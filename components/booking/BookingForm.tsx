    ...
    <form className="mt-4">
      ...
      <div className="grid sm:grid-cols-2 gap-4">
        <div>
          ...
          <input type="text" id="fname" name="firstName" className="border border-[#E7E6E6] rounded-lg px-3 py-2 md:p-3.5 w-full mt-2 outline-none focus:border-[#34967C]" />
        </div>
        <div>
          <label className="font-semibold" htmlFor="lname">Last Name</label>
          <input type="text" id="lname" name="lastName" className="border border-[#E7E6E6] rounded-lg px-3 py-2 md:p-3.5 w-full mt-2 outline-none focus:border-[#34967C]" />
        </div>
      </div>
      <div className="grid sm:grid-cols-2 gap-4 mt-4">
        <div>
          <label className="font-semibold" htmlFor="email">Email</label>
          <input type="email" id="email" name="email" className="border border-[#E7E6E6] rounded-lg px-3 py-2 md:p-3.5 w-full mt-2 outline-none focus:border-[#34967C]" />
        </div>
        <div>
          <label className="font-semibold" htmlFor="phone">Phone Number</label>
          <input type="text" id="phone" name="phone" className="border border-[#E7E6E6] rounded-lg px-3 py-2 md:p-3.5 w-full mt-2 outline-none focus:border-[#34967C]" />
        </div>
      </div>
      ...
      <label className="mt-6 grid grid-cols-[20px_1fr] gap-2">
        ...
        <div className="relative shrink-0 size-5">
            ...
            <div className="size-5 grid place-content-center rounded border sm:border-2 border-gray-400 peer-checked:border-[#34967C] peer-checked:bg-[#34967C] transition-colors duration-200">
            </div>
        ...
        <p className="-mt-p text-sm md:text-base">Receive text message update about your booking. Messages rate may apply.</p>
      </label>
      ...
      <div className="text-sm md:text-base mt-4 border border-[#E6E6E6] rounded-lg overflow-hidden">
        <div className="p-4 flex items-center gap-10">
            <h4 className="text-[#747474]">Card numbber</h4> <HiLockClosed className="" />
        </div>
      ...
      <div className="mt-4 flex justify-between items-center border border-[#E7E6E6] rounded-lg py-1 px-4 cursor-pointer">
        <div className="leading-none">
          ...
          <p className="text-sm md:text-lg font-medium text-[#161117]">Ghana</p>
        </div>
